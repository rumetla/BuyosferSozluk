using BuyosferSozluk.Api.Application.Features.Commands.Entry.CreateFav;
using BuyosferSozluk.Api.Application.Features.Commands.Entry.DeleteFav;
using BuyosferSozluk.Api.Application.Features.Commands.EntryComment.CreateFav;
using BuyosferSozluk.Api.Application.Features.Commands.EntryComment.DeleteFav;
using MediatR;
