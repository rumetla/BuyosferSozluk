...
using BuyosferSozluk.Api.Application.Features.Queries.GetEntryComments;
using BuyosferSozluk.Api.Application.Features.Queries.GetEntryDetail;
using BuyosferSozluk.Api.Application.Features.Queries.GetMainPageEntries;
using BuyosferSozluk.Api.Application.Features.Queries.GetUserEntries;
